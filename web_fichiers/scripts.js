...
function loadCountdown() {
    $('#clock')
    .countdown('2022/10/24 20:00', function(event) {
        var $this = $(this)
        .html(event.strftime('' +
...
function loadCountdown() {
    $('#clockconcours')
    .countdown('2022/10/30 20:30', function(event) {
        var $this = $(this)
        .html(event.strftime('[ %D Jours %Hh %Mm %Ss ]'));
    });
}
...
function speacialCount() {
    ...
    .countdown('2022/06/11', function(event) {
        $(this)
        .html(event.strftime('Temps restant : [ %D days %H:%S]'));
    });
}
function offheight() {
    if ($(window)
